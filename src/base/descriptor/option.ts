...
type OptionalState<MandatoryTypeDescriptor extends TypeDescriptor> = MandatoryTypeDescriptor['aState'] | undefined;

type OptionalMutable<MandatoryTypeDescriptor extends TypeDescriptor> = MandatoryTypeDescriptor['aMutable'] | undefined;
...
export function optionalDescriptor<
  MandatoryTypeDescriptor extends TypeDescriptor,
